# Allowed resource types (Custom)

This policy enables you to specify the resource types that your organization can deploy and enforce it.
It includes an exemption mechanism through tagging if following are present
* businesscontact
* engcontact
* ticket
* azpolicyExemptUntil as YYYY/MM/DD between current day and a year (if kept default values)
or
if part of UnrestrictedResourceGroups.
